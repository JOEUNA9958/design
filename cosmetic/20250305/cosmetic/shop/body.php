   ...
   <div class="sub_banner_wrap">
        <div class="sub_banner" style="background-image: url('../images/about/banner1.jpg');">
            ...
            <div class="sub_menu">
                ...
                <a href="/cosmetic/shop/body.php" class="active">바디/핸드케어</a>
            </div>
        </div>
    </div>
    ...
    <div class="shop-header">
        <div class="category-label">Body/Hand Care</div>
        <h2 class="category-title">바디/핸드케어</h2>
    </div>
   ...
   <!-- 제품 1 -->
    <div class="product-item">
        ...
        <div class="product-info">
            <div class="category">Body/Hand Care</div>
            <div class="name">바디/핸드케어 상품명</div>
        </div>
    </div>
