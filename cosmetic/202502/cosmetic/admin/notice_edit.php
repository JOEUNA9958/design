...
<head>
   ...
   <style>
       ...
       button {padding: 10px 40px; border: none; color: #fff; cursor: pointer;}
...
<div class="admin-wrap">
   ...
   <div class="content">
       <h2>공지사항 수정</h2>
       <form action="notice_edit_process.php" method="post">
           <input type="hidden" name="id" value="<?php echo $id; ?>">
           <table>
               <tr>
                   <th>제목</th>
                   <td><input type="text" name="title" value="<?php echo $view['title']; ?>" required></td>
               </tr>
               <tr>
                   <th>중요공지</th>
                   <td>
                       <input type="checkbox" name="is_important" value="1" 
                       <?php echo $view['is_important'] ? 'checked' : ''; ?>> 중요공지로 등록
                   </td>
               </tr>
               <tr>
                   <th>내용</th>
                   <td><textarea name="content" required><?php echo $view['content']; ?></textarea></td>
               </tr>
           </table>
           <div class="btn-wrap">
