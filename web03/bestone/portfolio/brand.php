...
// 전체 아이템 수 조회
$count_sql = "SELECT COUNT(*) as total FROM brand_products $where_clause";
...
<div class="sub_banner_wrap">
        <div class="sub_banner" style="background-image: url('/bestone/images/banner.png');">
            ...
            <a href="/bestone/portfolio/oemodm.php">OEM/ODM</a>
                <a href="/bestone/portfolio/brand.php"  class="active">브랜드명</a>
            </div>
        </div>
    </div>
...
<div class="portfolio-section">
    <div class="title-section">
        <h2 class="section-title">브랜드명</h2>
    </div>
    
    <!-- 카테고리 필터 -->
    <div class="category-filter">
        <button class="filter-btn <?php echo $category_filter == 'all' ? 'active' : ''; ?>" data-category="all">전체</button>
        <button class="filter-btn <?php echo $category_filter == 'skincare' ? 'active' : ''; ?>" data-category="skincare">스킨케어</button>
        <button class="filter-btn <?php echo $category_filter == 'bodycare' ? 'active' : ''; ?>" data-category="bodycare">바디케어</button>
        <button class="filter-btn <?php echo $category_filter == 'diy' ? 'active' : ''; ?>" data-category="diy">DIY 뷰티</button>
    </div>
    ...
    <div class="product-container">
        <div class="product-grid">
            ...
            ?>
                <a href="/bestone/portfolio/brand_detail.php?id=<?php echo $row['id']; ?>" class="product-item">
                    ...
                    <div class="product-info">
                        <span class="category">
                            ...
                            echo htmlspecialchars($category_names[$row['category']] ?? $row['category']); 
                            ?>
                        </span>
