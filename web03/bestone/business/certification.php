...
<div class="sub_banner_wrap">
        <div class="sub_banner" style="background-image: url('/bestone/images/banner.png');">
            ...
            <a href="/bestone/business/about.php">프로세스</a>
                ...
                <a href="/bestone/business/certification.php" class="active">인증</a>
            </div>
        </div>
    </div>
...
<div class="business-section">
    ...
    <div class="feature-grid">
        <!-- Feature 1 -->
            ...
            <div class="feature-header">
                <h3 class="feature-title">제조관리시스템인증</h3>
        ...
        <div class="feature-item">
        <div class="feature-header">
            <h3 class="feature-title">품질경영 & 환경경영시스템인증</h3>
            <div class="feature-icon">
                <div class="icon-circle">
    ...
    <div class="feature-item">
        <div class="feature-header">
            <h3 class="feature-title">상표 및 특허권</h3>
            <div class="feature-icon">
                <div class="icon-circle">
    ...
    <section class="business-process">
        <div class="process-header">
            <h5 class="sub-title">Certification List</h5>
            <h3 class="main-title">인증서 목록</h3>
        </div>
        ...
        <div class="process-steps">
            ...
            <div class="step-row">
                ...
                <div class="step-content">
                    ...
                    <h4>제조관리시스템인증 ISO22716</h4>
                    <p>전ISO22716은 화장품 제조, 보관 및 유통 과정에서의 품질 및 안전성을 보장합니다.</p>
                </div>
            </div>
            ...
            <div class="step-row">
                <div class="step-content">
                    ...
                    <h4>제조관리시스템인증 ISO22716</h4>
                    <p>ISO22716은 화장품 제조, 보관 및 유통 과정에서의 품질 및 안전성을 보장합니다.</p>
                </div>
                <div class="step-image">
    ...
    <section class="certification-image">
    <div class="container">
        <img src="/bestone/images/certification/all.jpg" alt="베스트원텍 인증서 현황">
    </div>
</section>
</div>
