...
<link rel="stylesheet" href="/theme/premium/css/swiper-bundle.min.css"> 
<script src="/theme/premium/js/swiper-bundle.min.js"></script>
<script src="/theme/premium/js/main.js"></script>
<link rel="stylesheet" href="/theme/premium/css/main.css"> 
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/4.0.11/fullpage.min.js"></script>

<?php }else{ ?>

<!-- 서브페이지일때만 -->
<script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId=7n2xnvrfv7"></script>
<script src="/theme/premium/js/sub.js"></script>
<link rel="stylesheet" href="/theme/premium/css/sub.css"> 

<?php } ?>

<script src="/theme/premium/js/jquery-3.7.1.min.js"></script>
<script src="/theme/premium/js/jquery.common.js"></script>

<link rel="stylesheet" href="/theme/premium/css/aos.css"> 
<script src="/theme/premium/js/aos.js"></script>
<script>
    AOS.init({
    }); // AOS 초기화
</script>
    ...
    <div id="header">
        ...
        <nav id="gnb" >
            ...
            <div class="gnb_wrap" data-aos="fade-up" >
                <ul class="depth1"  > <!--data-aos-delay="300"-->
                    <?php
