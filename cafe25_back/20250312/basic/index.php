...
<body>
    <script src="/theme/basic/js/Hayung_js/aos.js"></script>
    <script>
    ...
    <div id="wrap">
                ...
                <div class="swiper"> 
                    <ul class="swiper-wrapper"> 
                        <li class="swiper-slide">
                            ...
                            <div class="visual_txt" data-aos="fade-up" data-aos-delay="600">
                                <div class="wrapper">
                                    <h3>방문요양서비스를<br>
                                        전문적으로 하는<br>
                                        하융노인요양센터입니다.</h3>
        ...
        <div class="service">
            <div class="tit"  data-aos="fade-up" data-aos-delay="500">
