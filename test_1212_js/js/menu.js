$(document).ready(function(){
    ...
    let device_status //pc면 pc라는 겂이 저장, 모바일이면 mobile저장  
    let window_w 
    let menu_status
    ...
    /*
        ...
        >> 키보드 접근성 --- 마우스 오버가 아니라 키보드로 tab키를 눌러서 메뉴를 선택하고 이동 할 수 있어야함
        
        >> 메뉴는 pc메뉴에서 작동되는 jquery , 모바일에서 작동되는 jquery가 다름
           pc와 모바일을 구분하는 건 단순 브라우저의 넓이
    ...
    */
        ...
        // 키보드 이동으로 메뉴를 아웃시키는 것은 마지막 1차 메뉴의 마지막 2차메뉴에서 포커스가 사라지면 메뉴 닫기
