/*common.js  header / footer 공통요소에 들어가는 스크립트 저장 , 모든 페이지에서 공통으로 작동되는 스크립트 저장 */
$(document).ready(function(){
     ...
     * 1. a의 링크 삭제 (작동x)
     * 2. 상위 li에 open 클래스를 줌
     * 3. 만약에 이미 open가 있는 요소이면 il에 open삭제, 
     *    닫혀있는 메뉴면 열기
     * 
     */
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li > a').on('click', function(e){
        if(device_status == 'mobile'){
            e.preventDefault();
            if($(this).parent().hasClass('open') == true){ //현재 열려있는 상태
     ...
     * header .gnb .gnb_wrap .gnb_close 을 클릭하면 header menu_mo 클래스 삭제
     */
