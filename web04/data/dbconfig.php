...
define('G5_MYSQL_USER', 'dhskqkd');
define('G5_MYSQL_PASSWORD', 'dhxogns##88');
define('G5_MYSQL_DB', 'dhskqkd');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'da6ddd2fde50a73ed84bfdf3c3115aa1'); // 토큰 암호화에 사용할 키
