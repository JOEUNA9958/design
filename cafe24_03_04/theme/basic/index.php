    ...
    <div id="wrap">
        <div class="visual">
            ...
            <div class="link">
                <ul>
                    <li class="ico1">
                        <a href="contents/business_01.html" >
                            <h3>요양보험</h3>
                    ...
                    <li class="ico2">
                        <a href="contents/business_04.html">
                            <h3>방문요양</h3>
        ...
        <div class="communtiy">
            <div class="wrapper">
                <div class="tit">
                    ...
                    <div class="btn_wrap">
                        <a href="contents/business_02.html  ">신청절차</a>
                        <a href="contents/business_01.html">제도안내</a>
                    </div><!--btn_wrap-->
                </div><!--tit-->
            ...
            <div class="wrapper">
                ...
                <div class="customer">
                    <h3>고객센터</h3>
                        ...
                        <div class="btn_wrap">
                            <a href="#n" class="online">온라인 문의</a>
                            <a href="contents/company_02.html" class="map">오시는 길</a>
                        </div>
                </div><!--customer-->
            </div><!--wrapper-->
        </div><!--inquire-->
