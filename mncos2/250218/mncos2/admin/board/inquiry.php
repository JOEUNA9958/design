                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($inquiry['status'] === 'COMPLETED') {
                            // 답변완료 상태일 때는 '답변수정' 버튼 표시
                            echo '<a href="inquiry_answer.php?id=' . $inquiry['id'] . '" class="answer-btn">답변수정</a>';
                        } else {
                            // 접수나 처리중 상태일 때는 '답변하기' 버튼 표시
                            echo '<a href="inquiry_answer.php?id=' . $inquiry['id'] . '" class="answer-btn">답변하기</a>';
                        }
                        ?>
                        <a href="javascript:void(0)" onclick="deleteInquiry(<?php echo $inquiry['id']; ?>)" class="btn">삭제</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script>
        ...
        function deleteInquiry(id) {
            if (confirm('정말 삭제하시겠습니까?')) {
                location.href = `admin_delete.php?id=${id}`;
            }
        }
    </script>
</body>
