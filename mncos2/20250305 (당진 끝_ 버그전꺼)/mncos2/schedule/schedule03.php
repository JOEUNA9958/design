...
<body>
    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="/mncos2/images/works/schedule03-img01.jpg" alt="성희롱개선1">
                </div>
                <div class="swiper-slide">
                    <img src="/mncos2/images/works/schedule03-img02.jpg" alt="성희롱개선2">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            사업명 : 공공부문 성희롱 행위자 인식개선 교육<br>
            목적 : 공공부문 성희롱 해위자의 기관 복귀 전에 성인지 감수성을 제고하고 조직문화에서의 성차별 및 위계 발견, 고정관념 점검, 2차 예방 및 피해자 공감 등을 교육하여 사건 재발방지 도모
            기간 : 년 중 수시 진행<br>
            대상 : 공공기관(중앙행정기관, 지자체, 공직유관단체, 교육청 등) 성희롱 행위자 <br>
            추진방법 : 성희롱·성폭력 예방교육 전문가의 성희롱 행위자 인식개선 교육 수행 <br>
            주요내용 : -교육과정 : 10회기과정(20시간 교육), 5회기 과정(10시간 교육) <br>
            </p>
            <p class="business-desc">
            ※ 여성가족부(2018) 공공부문 성희롱 행위자 인식개선을 위한 상담 및 교육 프로그램 매뉴얼 <br>
            - 교육방법 : 1:1 대면 상담형 교육
