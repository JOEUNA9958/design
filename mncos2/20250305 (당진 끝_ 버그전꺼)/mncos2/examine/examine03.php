    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <img src="/mncos2/images/works/examine03-img01.jpg" alt="MBTI">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            <p class="business-desc">
                 MBTI는 좋고 나쁨을 가리는 진단검사가 아니며, 선천적인 선호 경향 자체에도 좋고 나쁨이 없다. 좋고 [효율적] 나쁨 [비효율적]의 가치판단은 환경이라는 변수가 개입되면서 우리가 내리는 판단일 뿐이다. 저자들은 성격 유형에는 “ 더 좋고 더 나쁜”, “더 능력있고 없는” 유형이 없다는 개념을 전달하기 위해 자연계의 예를 상징적으로 많이 든다. 즉, 사과와 배와 감을 보자. 그 과일 자체가 더 좋고 더 나쁜 것은 없다. 각각의 맛과 향기와 빛깔이 있을 뿐이다. 단지 그것을 먹는 사람의 상황에 따라 어떤 사람은 감을, 어떤 사람은 배를 더 좋게 혹언, 더 나쁘게 생각할 뿐이다. 성격유형은 그 자체가 더 좋고 더 나쁜 유형은 없다. 이것은 산은 산으로 물은 물로써 존재하는 그 자체로 의미있는 것과 같다.
            </p>
        </div>
