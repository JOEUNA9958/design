    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <img src="/mncos2/images/works/examine06-img01.jpg" alt="결혼만족도검사">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            <p class="business-desc">
                전반적인 결혼 불만족 정도와 결혼 생활 영역에 대한 세부적인 결혼 만족도 정도를 평가한다. 부부 갈등의 원인을 파악하고 둘만의 노력으로 해결이 쉽지 않은 경우 평가하는 도구이다. 
            </p>
        </div>
