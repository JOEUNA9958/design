    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <img src="/mncos2/images/works/examine01-img01.jpg" alt="MMPI">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            <p class="business-desc">
                MMPI 심리검사 다면적 인성 검사는 세계적으로 널리 사용되는 심리 검사 중 하나이며, 원래 정신질환 진단을 위해 개발되었지만, 현재는 심리상담, 임상 진단, 인사관리, 교육 등 여러 분야에서 활용된다.
            </p>
        </div>
