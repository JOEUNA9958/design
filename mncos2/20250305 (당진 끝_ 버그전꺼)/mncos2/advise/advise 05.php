    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="/mncos2/images/works/advise 05-img01.jpg" alt="정신역동집단상담">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            <p class="business-category">
                집단상담은 무의식에 억압되어 있던 감정들을 집단 내의 상호작용을 통해서 재경험하고 과거의 왜곡된 인간관계 패턴을 통찰함으로써 새로운 인간관계를 연습하고 형성해 가는 과정이다. 
