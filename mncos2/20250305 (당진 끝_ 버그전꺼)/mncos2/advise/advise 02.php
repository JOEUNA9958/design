    ...
    <div class="works-content">
        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <img src="/mncos2/images/works/advise 02-img01.jpg" alt="가족상담">
                </div>
            </div>
        </div>
        ...
        <div class="business-content">
            ...
            <p class="business-category">
                아이들에게 문제가 생기면 가족 내에 문제가 있지 않나 의심하는 경우가 많은데 실제 누구의 잘못이라기보다는 가족의 기능이 제대로 이루어지지 않기 때문입니다.
            </p>
            <p class="business-desc">
                소위 역기능적 가족이기 때문이지요.
                이런 가족이 가족이라는 한 단위로서 제대로 그 역할을 해낼 수 있도록, 그래서 기능적인 가족이 되도록 돕는 것이 가족치료입니다.
                때에 따라 그렇지 못한 경우도 있지만 대개는 전 가족이 오도록 권유하지요.
                가족의 권력 구조는 어떠하며, 가족 간 의사소통은 잘 되고 있는지, 가족의 친밀도는 좋은지, 가족 내에 어떤 악순환이 계속되고 있는지, 어떠한 해결 방법을 시도해 보았는지, 가족의 여러 기능을 상세히 살펴보고 이를 해결해 나가는 치료 방법입니다.
            </p>
        </div>
