...
$config = array();
$member = array('mb_id' => '', 'mb_level' => 1, 'mb_name' => '', 'mb_certify' => '', 'mb_email' => '', 'mb_open' => '', 'mb_homepage' => '', 'mb_tel' => '', 'mb_hp' => '', 'mb_addr_jibeon' => '', 'mb_signature' => '');
...
//==============================================================================
define('G5_HTTP_COMMUNITY_URL', https_url(G5_COMMUNITY_DIR, false));
define('G5_HTTPS_COMMUNITY_URL', https_url(G5_COMMUNITY_DIR, true));
...
if ($bo_table) {
    ...
    // config에 설정된 에디터 사용 -> bo_select_editor 불필요
...
// 도메인 설정 - 실제 도메인 구매 후 아래 주소를 변경해주세요
// 예시 $allowed_domain = 'https://yourdomain.com ';  
$allowed_domain = '*';  // 현재는 모든 도메인 허용
