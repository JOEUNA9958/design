...
<div class="wrapper__bo_w">

    <section id="bo_w">
        <h2 class="title__bo_w"><?php echo $g5['write_title'] ?></h2>
        ...
        <?php } ?> -->
            ...
            <div class="btn_confirm write_div">
                ...
                <button type="submit" id="btn_submit" accesskey="s"
                    class="btn_submit btn"><?php echo $wr_id ? '수정' : '작성' ?>완료</button>
            </div>
        </form>
        ...
        <script>
            ...
            function fwrite_submit(f) {
                ...
                var content = "";
                $.ajax({
                    url: g5_community_url + "/ajax.filter.php",
                    type: "POST",
                    data: {
